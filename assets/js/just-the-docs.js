...
function initSearch() {
  ...
  request.open('GET', '{{ "assets/js/zzzz-search-data.json" | relative_url }}', true);
  ...
  request.onload = function(){
    if (request.status >= 200 && request.status < 400) {
      ...
      lunr.tokenizer.separator = {{ site.search.tokenizer_separator | default: site.search_tokenizer_separator | default: '/[\\s\\-/]+|[\\u4e00-\\u9fa5]+/' }};
